                    ...
                    <div class="sidebar-content scrollable">
                        ...
                        <form action="{{ route('frontend.product.search') }}" method="GET">
                                    ...
                                    <h3 class="">
                                        <ul class="">
                                            <li>
                                                ...
                                                <input type="checkbox" style="margin-right: 16px;">{{ $product->category}}</input>
                                            </li>
                                        </ul>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('frontend.product')}}" class="btn btn-success" id="reset">Reset</a>
                            </div>
                        </form>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                            <div class="product_grid card b-0">
                                ...
                                <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                                    <div class="text-left">
                                        <div class="text-left">
                                            <div class="elso_titl"><span class="small">{{ $product->name }}</span></div>
                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html">{{ $product->category}}</a></h5>
