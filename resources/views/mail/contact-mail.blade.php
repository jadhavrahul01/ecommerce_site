                        ...
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                ...
                                <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                    <img src="{{ url('user-assets/images/al-yasmeen.png') }}" width="155"
                                        alt="al-yasmeen"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p class="sm-leading-32"
                                                ...
                                                ✉️ New {{ $formName }} Form Submission ✅
                                            </p>

                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px; margin-bottom: 24px;">

                                                <span style="font-weight: 600;">name:</span> {{ $contact->name }} <br>
                                                <span style="font-weight: 600;">email:</span> {{ $contact->email }} <br>
                                                <span style="font-weight: 600;">phone:</span> {{ $contact->phone }} <br>
                                                <span style="font-weight: 600;">message:</span> {{ $contact->message }}
                                                <br>
                                            </p>
